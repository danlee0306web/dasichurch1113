        ...
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <a href="../customer_order/list.php?Status=0">新訂單</a>
                </li>
                <li>
                  <a href="../customer_order/list.php?Status=1">已付款</a>
                </li>
                <li>
                  <a href="../customer_order/list.php?Status=2">出貨中</a>
                </li>
                <li class="divider"></li>
                <li>
                  <a href="../customer_order/list.php?Status=3">已出貨</a>
                </li>
                <li class="divider"></li>
                <li>
                  <a href="../customer_order/list.php?Status=4">已送達(交易完成)</a>
                </li>
                <li class="divider"></li>
                <li>
                  <a href="../customer_order/list.php?Status=99">取消訂單</a>
                </li>
              </ul>
            </li>
          </ul>
